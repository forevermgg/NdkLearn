...
/*!
    ...
    \list
    \li Class names needs to contain the fully-qualified class name, for
   example: \b"java/lang/String". \li Method signatures are written as
   \b"(Arguments)ReturnType" \li All object types are returned as a
   QAndroidJniObject. \endlist

    \section1 Method Signatures

    For functions that take no arguments, QAndroidJniObject provides convenience
   ...
   signature structure is \b \(A\)R, where \b A is the type of the argument\(s\)
   and \b R is the return type. Array types in the signature must have the \b\[
   suffix and the fully-qualified type names must have the \b L prefix and \b ;
   suffix.
   ...
   QAndroidJniObject::callStaticObjectMethod("org/qtproject/qt5/TestClass",
                                                                               "fromNumber"
                                                                               "(I)Ljava/lang/String;",
                                                                               10);
    \endcode
   ...
   QAndroidJniObject::callStaticObjectMethod("org/qtproject/qt5/TestClass",
    ...
    When calling Java functions that might throw an exception, it is important
   that you check, handle and clear out the exception before continuing.
   ...
   done by creating a function declaration in Java and prefixing it with the \b
   ...
   functions can be done by calling the RegisterNatives() function through the
   \l{QAndroidJniEnvironment}{JNI environment pointer}.
    ...
    C++ Implementation:
    \snippet code/src_androidextras_qandroidjniobject.cpp Registering native
   methods

    \section1 The Lifetime of a Java Object

    Most \l{Object types}{objects} received from Java will be local references
   and will only stay valid in the scope you received them. After that, the
   object becomes eligible for garbage collection. If you want to keep a Java
   object alive you need to either create a new global reference to the object
   and release it when you are done, or construct a new QAndroidJniObject and
   let it manage the lifetime of the Java object. \sa object()

    \note The QAndroidJniObject does only manage its own references, if you
   construct a QAndroidJniObject from a global or local reference that reference
   will not be released by the QAndroidJniObject.
    ...
    For more information about JNI see: \l
...
/*!
    ...
    Constructs a new QAndroidJniObject by calling the default constructor of \a
   className.
...
/*!
    \fn QAndroidJniObject::QAndroidJniObject(const char *className, const char
   *signature, ...)

    Constructs a new QAndroidJniObject by calling the constructor of \a
   className with \a signature and arguments.

    \code

    ...
    jstring myJStringArg = ...;
    QAndroidJniObject myNewJavaString("java/lang/String",
   "(Ljava/lang/String;)V", myJStringArg);
    ...
...
/*!
   ...
   clazz.
    ...
    Note: The QAndroidJniObject will create a new reference to the class \a
   clazz and releases it again when it is destroyed. References to the class
   created outside the QAndroidJniObject needs to be managed by the caller.

*/

/*!
    \fn QAndroidJniObject::QAndroidJniObject(jclass clazz, const char
   *signature, ...)

    Constructs a new QAndroidJniObject from \a clazz by calling the constructor
   with \a signature and arguments.
...
/*!
    ...
    Note: The QAndroidJniObject will hold a reference to the Java object \a
   object and release it when destroyed. Any references to the Java object \a
   object outside QAndroidJniObject needs to be managed by the caller.

    \sa fromLocalRef()
*/

/*!
    Destroys the QAndroidJniObject and releases any references held by the
   QAndroidJniObject.
*/
...
/*!
    \fn T QAndroidJniObject::callMethod(const char *methodName, const char
   *signature, ...) const
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::callObjectMethod(const char
   *methodName) const

    Calls the Java objects method \a methodName and returns a new
   QAndroidJniObject for the returned Java object.

    \code
    ...
    QAndroidJniObject myJavaString1 = ...;
    QAndroidJniObject myJavaString2 =
   myJavaString1.callObjectMethod<jstring>("toString");
    ...
    \endcode
*/
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::callObjectMethod(const char
   *methodName, const char *signature, ...) const

    Calls the Java object's method \a methodName with the signature \a signature
   and arguments

    \code
    QAndroidJniObject myJavaString; ==> "Hello, Java"
    QAndroidJniObject mySubstring = myJavaString.callObjectMethod("substring",
   "(II)Ljava/lang/String;", 7, 10); \endcode
*/

/*!
    \fn T QAndroidJniObject::callStaticMethod(jclass clazz, const char
   *methodName)
    ...
    jdouble randNr = QAndroidJniObject::callStaticMethod<jdouble>(javaMathClass,
   "random");
    ...
    \endcode
*/
...
/*!
    \fn T QAndroidJniObject::callStaticMethod(const char *className, const char
   *methodName)
   ...
   value.
    ...
    \code
    jint value = QAndroidJniObject::callStaticMethod<jint>("MyClass",
   "staticMethod"); \endcode
*/
...
/*!
   ...
   *methodName, const char *signature, ...)
    ...
    Calls the static method with \a methodName with \a signature on class \a
   className with optional arguments.

    \code
    ...
    jint a = 2;
    jint b = 4;
    jint max = QAndroidJniObject::callStaticMethod<jint>("java/lang/Math",
   "max", "(II)I", a, b);
    ...
    \endcode
*/
...
/*!
   ...
   *methodName, const char *signature, ...)
    ...
    Calls the static method \a methodName with \a signature on \a clazz and
   returns the value.
    ...
    jint a = 2;
    jint b = 4;
    jint max = QAndroidJniObject::callStaticMethod<jint>(javaMathClass, "max",
   "(II)I", a, b);
    ...
    \endcode
*/
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::callStaticObjectMethod(const char
   *className, const char *methodName)
   ...
   QAndroidJniObject::callStaticObjectMethod<jstring>("CustomClass",
   "getClassName"); \endcode
*/
...
/*!
   ...
   *className, const char *methodName, const char *signature, ...)
    ...
    Calls the static method with \a methodName and \a signature on the class \a
   className.

    \code
    QAndroidJniObject thread =
   QAndroidJniObject::callStaticObjectMethod("java/lang/Thread",
   "currentThread", "()Ljava/lang/Thread;"); QAndroidJniObject string =
   QAndroidJniObject::callStaticObjectMethod("java/lang/String", "valueOf",
   "(I)Ljava/lang/String;", 10); \endcode
*/

/*!
    \fn QAndroidJniObject QAndroidJniObject::callStaticObjectMethod(jclass
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::callStaticObjectMethod(jclass
   clazz, const char *methodName, const char *signature, ...)

    Calls the static method with \a methodName and \a signature on class \a
   clazz.
*/
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::getObjectField(const char
   *fieldName) const
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::getObjectField(const char
   *fieldName, const char *signature) const
    ...
    \code
    QAndroidJniObject field = jniObject.getObjectField("FIELD_NAME",
   "Ljava/lang/String;"); \endcode
*/

/*!
    \fn T QAndroidJniObject::getStaticField(const char *className, const char
   *fieldName)
...
/*!
    \fn QAndroidJniObject QAndroidJniObject::getStaticObjectField(const char
   *className, const char *fieldName)

    Retrieves the object from the field \a fieldName on the class \a className.

    \code
    QAndroidJniObject jobj =
   QAndroidJniObject::getStaticObjectField<jstring>("class/with/Fields",
   "FIELD_NAME"); \endcode
*/

/*!
    \fn QAndroidJniObject QAndroidJniObject::getStaticObjectField(const char
   *className, const char *fieldName, const char *signature) Retrieves the
   object from the field with \a signature and \a fieldName on class \a
   className.
    ...
    \code
    QAndroidJniObject jobj =
   QAndroidJniObject::getStaticObjectField("class/with/Fields", "FIELD_NAME",
   "Ljava/lang/String;"); \endcode
*/

/*!
    \fn QAndroidJniObject QAndroidJniObject::getStaticObjectField(jclass clazz,
   const char *fieldName)
    ...
    \code
    QAndroidJniObject jobj =
   QAndroidJniObject::getStaticObjectField<jstring>(clazz, "FIELD_NAME");
    \endcode
*/

/*!
    \fn QAndroidJniObject QAndroidJniObject::getStaticObjectField(jclass clazz,
   const char *fieldName, const char *signature) Retrieves the object from the
   field with \a signature and \a fieldName on \a clazz.

    \note Since \b{Qt 5.3} this function can be used without a template type.

    \code
    QAndroidJniObject jobj = QAndroidJniObject::getStaticObjectField(clazz,
...
/*!
    \fn void QAndroidJniObject::setField(const char *fieldName, const char
   *signature, T value)
   ...
   stringArray.object<jobjectArray>()) \endcode
*/

/*!
    \fn void QAndroidJniObject::setStaticField(const char *className, const char
   *fieldName, T value)

    Sets the value of the static field \a fieldName in class \a className to \a
   value.
*/

/*!
    \fn void QAndroidJniObject::setStaticField(const char *className, const char
   *fieldName, const char *signature, T value);

    Sets the static field with \a fieldName and \a signature to \a value on
   class \a className.
*/

/*!
    \fn void QAndroidJniObject::setStaticField(jclass clazz, const char
   *fieldName, T value)
...
/*!
    ...
    \note The returned object is still owned by the QAndroidJniObject. If you
   want to keep the object valid you should create a new QAndroidJniObject or
   make a new global reference to the object and free it yourself.

    \snippet code/src_androidextras_qandroidjniobject.cpp QAndroidJniObject
   scope

    \note Since \b{Qt 5.3} this function can be used without a template type, if
   the returned type is a \c jobject.
...
/*!
    ...
    Creates a Java string from the QString \a string and returns a
   QAndroidJniObject holding that string.
...
/*!
   ...
   raw JNI calls, through the JNI environment, returns local references to a
   java object.
...
/*!
    \fn bool operator==(const QAndroidJniObject &o1, const QAndroidJniObject
   &o2) \relates QAndroidJniObject
...
QAndroidJniObject::QAndroidJniObject(const char *className, const char *sig,
  ...
  va_start(args, sig);
  d = std::shared_ptr<QJNIObjectPrivate>(
      new QJNIObjectPrivate(className, sig, vargs));
  va_end(args);
}
...
QAndroidJniObject::QAndroidJniObject(jclass clazz, const char *sig, ...) {
  ...
  va_start(args, sig);
  d = std::shared_ptr<QJNIObjectPrivate>(
      new QJNIObjectPrivate(clazz, sig, vargs));
  va_end(args);
}
...
QAndroidJniObject::QAndroidJniObject(const char *className)
    : d(new QJNIObjectPrivate(className)) {}

QAndroidJniObject::QAndroidJniObject(jclass clazz)
    : d(new QJNIObjectPrivate(clazz)) {}

QAndroidJniObject::QAndroidJniObject(jobject obj)
    : d(new QJNIObjectPrivate(obj)) {}

QAndroidJniObject::QAndroidJniObject(const QJNIObjectPrivate &o)
    : d(new QJNIObjectPrivate(o)) {}

template <>
void QAndroidJniObject::callMethod<void>(const char *methodName,
...
template <>
jboolean QAndroidJniObject::callMethod<jboolean>(const char *methodName,
                                                 const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jbyte QAndroidJniObject::callMethod<jbyte>(const char *methodName,
                                           const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jchar QAndroidJniObject::callMethod<jchar>(const char *methodName,
                                           const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jshort QAndroidJniObject::callMethod<jshort>(const char *methodName,
                                             const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jint QAndroidJniObject::callMethod<jint>(const char *methodName,
                                         const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jlong QAndroidJniObject::callMethod<jlong>(const char *methodName,
                                           const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jfloat QAndroidJniObject::callMethod<jfloat>(const char *methodName,
                                             const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
jdouble QAndroidJniObject::callMethod<jdouble>(const char *methodName,
                                               const char *sig, ...) const {
  va_list args;
  va_start(args, sig);
...
template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jobject>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()Ljava/lang/Object;");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jclass>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()Ljava/lang/Class;");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jstring>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()Ljava/lang/String;");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jobjectArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[Ljava/lang/Object;");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jbooleanArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[Z");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jbyteArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[B");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jcharArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[C");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jshortArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[S");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jintArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[I");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jlongArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[J");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jfloatArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[F");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jdoubleArray>(
    const char *methodName) const {
  return d->callObjectMethod(methodName, "()[D");
}

template <>
QAndroidJniObject QAndroidJniObject::callObjectMethod<jthrowable>(
    const char *methodName) const {
...
jboolean QAndroidJniObject::callStaticMethod<jboolean>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jboolean res = QJNIObjectPrivate::callStaticMethodV<jboolean>(
      className, methodName, sig, args);
  va_end(args);
  return res;
}
...
jbyte QAndroidJniObject::callStaticMethod<jbyte>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jbyte res = QJNIObjectPrivate::callStaticMethodV<jbyte>(className, methodName,
                                                          sig, args);
  va_end(args);
  return res;
}
...
jbyte QAndroidJniObject::callStaticMethod<jbyte>(jclass clazz,
  ...
  va_start(args, sig);
  jbyte res =
      QJNIObjectPrivate::callStaticMethodV<jbyte>(clazz, methodName, sig, args);
  va_end(args);
  return res;
}
...
jchar QAndroidJniObject::callStaticMethod<jchar>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jchar res = QJNIObjectPrivate::callStaticMethodV<jchar>(className, methodName,
                                                          sig, args);
  va_end(args);
  return res;
}
...
jchar QAndroidJniObject::callStaticMethod<jchar>(jclass clazz,
  ...
  va_start(args, sig);
  jchar res =
      QJNIObjectPrivate::callStaticMethodV<jchar>(clazz, methodName, sig, args);
  va_end(args);
  return res;
}
...
jshort QAndroidJniObject::callStaticMethod<jshort>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jshort res = QJNIObjectPrivate::callStaticMethodV<jshort>(
      className, methodName, sig, args);
  va_end(args);
  return res;
}
...
jshort QAndroidJniObject::callStaticMethod<jshort>(jclass clazz,
  ...
  va_list args;
  va_start(args, sig);
  jshort res = QJNIObjectPrivate::callStaticMethodV<jshort>(clazz, methodName,
                                                            sig, args);
  va_end(args);
  return res;
}
...
jint QAndroidJniObject::callStaticMethod<jint>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jint res = QJNIObjectPrivate::callStaticMethodV<jint>(className, methodName,
                                                        sig, args);
  va_end(args);
  return res;
}
...
jint QAndroidJniObject::callStaticMethod<jint>(jclass clazz,
  ...
  va_start(args, sig);
  jint res =
      QJNIObjectPrivate::callStaticMethodV<jint>(clazz, methodName, sig, args);
  va_end(args);
  return res;
}
...
jlong QAndroidJniObject::callStaticMethod<jlong>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jlong res = QJNIObjectPrivate::callStaticMethodV<jlong>(className, methodName,
                                                          sig, args);
  va_end(args);
  return res;
}
...
jlong QAndroidJniObject::callStaticMethod<jlong>(jclass clazz,
  ...
  va_start(args, sig);
  jlong res =
      QJNIObjectPrivate::callStaticMethodV<jlong>(clazz, methodName, sig, args);
  va_end(args);
  return res;
}
...
jfloat QAndroidJniObject::callStaticMethod<jfloat>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jfloat res = QJNIObjectPrivate::callStaticMethodV<jfloat>(
      className, methodName, sig, args);
  va_end(args);
  return res;
}
...
jfloat QAndroidJniObject::callStaticMethod<jfloat>(jclass clazz,
  ...
  va_list args;
  va_start(args, sig);
  jfloat res = QJNIObjectPrivate::callStaticMethodV<jfloat>(clazz, methodName,
                                                            sig, args);
  va_end(args);
  return res;
}
...
jdouble QAndroidJniObject::callStaticMethod<jdouble>(const char *className,
  ...
  va_list args;
  va_start(args, sig);
  jdouble res = QJNIObjectPrivate::callStaticMethodV<jdouble>(
      className, methodName, sig, args);
  va_end(args);
  return res;
}
...
jdouble QAndroidJniObject::callStaticMethod<jdouble>(jclass clazz,
  ...
  va_list args;
  va_start(args, sig);
  jdouble res = QJNIObjectPrivate::callStaticMethodV<jdouble>(clazz, methodName,
                                                              sig, args);
  va_end(args);
  return res;
}

QAndroidJniObject QAndroidJniObject::callStaticObjectMethod(
    const char *className, const char *methodName, const char *sig, ...) {
  va_list args;
  va_start(args, sig);
  QJNIObjectPrivate res = QJNIObjectPrivate::callStaticObjectMethodV(
      className, methodName, sig, args);
  va_end(args);
  return res;
}
...
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod(
  ...
  QJNIObjectPrivate res =
      QJNIObjectPrivate::callStaticObjectMethodV(clazz, methodName, sig, args);
  va_end(args);
  return res;
}
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jobject>(
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jclass>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jstring>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jobjectArray>(
    const char *className, const char *methodName) {
  return callStaticObjectMethod(className, methodName, "()[Ljava/lang/Object;");
}
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jbooleanArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jbyteArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jcharArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jshortArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jintArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jlongArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jfloatArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jdoubleArray>(
    const char *className, const char *methodName) {
...
template <>
QAndroidJniObject QAndroidJniObject::callStaticObjectMethod<jthrowable>(
    const char *className, const char *methodName) {
  return callStaticObjectMethod(className, methodName,
...
QAndroidJniObject QAndroidJniObject::getObjectField(const char *fieldName,
                                                    const char *sig) const {
  return d->getObjectField(fieldName, sig);
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jobject>(
    const char *fieldName, const char *sig) const {
  return d->getObjectField(fieldName, sig);
}
...
template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jclass>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "Ljava/lang/Class;");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jbooleanArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[Z");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jbyteArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[B");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jcharArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[C");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jshortArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[S");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jintArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[I");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jlongArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[J");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jfloatArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[F");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jdoubleArray>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "[D");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jstring>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "Ljava/lang/String;");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jthrowable>(
    const char *fieldName) const {
  return d->getObjectField(fieldName, "Ljava/lang/Throwable;");
}

template <>
QAndroidJniObject QAndroidJniObject::getObjectField<jobjectArray>(
    const char *fieldName, const char *sig) const {
  return d->getObjectField(fieldName, sig);
}

template <>
void QAndroidJniObject::setField<jboolean>(const char *fieldName,
                                           jboolean value) {
...
template <>
void QAndroidJniObject::setField<jdouble>(const char *fieldName,
                                          jdouble value) {
...
template <>
void QAndroidJniObject::setField<jclass>(const char *fieldName, jclass value) {
  setField<jobject>(fieldName, "Ljava/lang/Class;", value);
}

template <>
void QAndroidJniObject::setField<jstring>(const char *fieldName,
                                          jstring value) {
  d->setField<jstring>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jbooleanArray>(const char *fieldName,
                                                jbooleanArray value) {
  d->setField<jbooleanArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jbyteArray>(const char *fieldName,
                                             jbyteArray value) {
  d->setField<jbyteArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jcharArray>(const char *fieldName,
                                             jcharArray value) {
  d->setField<jcharArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jshortArray>(const char *fieldName,
                                              jshortArray value) {
  d->setField<jshortArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jintArray>(const char *fieldName,
                                            jintArray value) {
  d->setField<jintArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jlongArray>(const char *fieldName,
                                             jlongArray value) {
  d->setField<jlongArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jfloatArray>(const char *fieldName,
                                              jfloatArray value) {
  d->setField<jfloatArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jdoubleArray>(const char *fieldName,
                                               jdoubleArray value) {
  d->setField<jdoubleArray>(fieldName, value);
}

template <>
void QAndroidJniObject::setField<jthrowable>(const char *fieldName,
                                             jthrowable value) {
  d->setField<jobject>(fieldName, "Ljava/lang/Throwable;", value);
}

template <>
jboolean QAndroidJniObject::getStaticField<jboolean>(jclass clazz,
                                                     const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jboolean>(clazz, fieldName);
}

template <>
jboolean QAndroidJniObject::getStaticField<jboolean>(const char *className,
                                                     const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jboolean>(className, fieldName);
}

template <>
jbyte QAndroidJniObject::getStaticField<jbyte>(jclass clazz,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jbyte>(clazz, fieldName);
}

template <>
jbyte QAndroidJniObject::getStaticField<jbyte>(const char *className,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jbyte>(className, fieldName);
}

template <>
jchar QAndroidJniObject::getStaticField<jchar>(jclass clazz,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jchar>(clazz, fieldName);
}

template <>
jchar QAndroidJniObject::getStaticField<jchar>(const char *className,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jchar>(className, fieldName);
}

template <>
jshort QAndroidJniObject::getStaticField<jshort>(jclass clazz,
                                                 const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jshort>(clazz, fieldName);
}

template <>
jshort QAndroidJniObject::getStaticField<jshort>(const char *className,
                                                 const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jshort>(className, fieldName);
}

template <>
jint QAndroidJniObject::getStaticField<jint>(jclass clazz,
                                             const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jint>(clazz, fieldName);
}

template <>
jint QAndroidJniObject::getStaticField<jint>(const char *className,
                                             const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jint>(className, fieldName);
}

template <>
jlong QAndroidJniObject::getStaticField<jlong>(jclass clazz,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jlong>(clazz, fieldName);
}

template <>
jlong QAndroidJniObject::getStaticField<jlong>(const char *className,
                                               const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jlong>(className, fieldName);
}

template <>
jfloat QAndroidJniObject::getStaticField<jfloat>(jclass clazz,
                                                 const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jfloat>(clazz, fieldName);
}

template <>
jfloat QAndroidJniObject::getStaticField<jfloat>(const char *className,
                                                 const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jfloat>(className, fieldName);
}

template <>
jdouble QAndroidJniObject::getStaticField<jdouble>(jclass clazz,
                                                   const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jdouble>(clazz, fieldName);
}

template <>
jdouble QAndroidJniObject::getStaticField<jdouble>(const char *className,
                                                   const char *fieldName) {
  return QJNIObjectPrivate::getStaticField<jdouble>(className, fieldName);
}

template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jobject>(
    jclass clazz, const char *fieldName, const char *sig) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jobject>(
    const char *className, const char *fieldName, const char *sig) {
  return QJNIObjectPrivate::getStaticObjectField(className, fieldName, sig);
}

template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jobjectArray>(
    jclass clazz, const char *fieldName, const char *sig) {
  return QJNIObjectPrivate::getStaticObjectField(clazz, fieldName, sig);
}
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jobject>(
    jclass clazz, const char *fieldName) {
  return QJNIObjectPrivate::getStaticObjectField(clazz, fieldName,
                                                 "Ljava/lang/Object;");
}
...
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jobject>(
  ...
  return QJNIObjectPrivate::getStaticObjectField(className, fieldName,
                                                 "Ljava/lang/Object;");
}

template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jclass>(
    jclass clazz, const char *fieldName) {
  return QJNIObjectPrivate::getStaticObjectField(clazz, fieldName,
                                                 "Ljava/lang/Class;");
}
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jstring>(
    jclass clazz, const char *fieldName) {
  return QJNIObjectPrivate::getStaticObjectField(clazz, fieldName,
                                                 "Ljava/lang/String;");
}
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jbooleanArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jbyteArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jcharArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jshortArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jintArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jlongArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jfloatArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jdoubleArray>(
    jclass clazz, const char *fieldName) {
...
template <>
QAndroidJniObject QAndroidJniObject::getStaticObjectField<jthrowable>(
    jclass clazz, const char *fieldName) {
  return QJNIObjectPrivate::getStaticObjectField(clazz, fieldName,
                                                 "Ljava/lang/Throwable;");
}
...
template <>
void QAndroidJniObject::setStaticField<jboolean>(jclass clazz,
                                                 const char *fieldName,
                                                 jboolean value) {
...
template <>
void QAndroidJniObject::setStaticField<jbyte>(jclass clazz,
                                              const char *fieldName,
                                              jbyte value) {
...
template <>
void QAndroidJniObject::setStaticField<jchar>(jclass clazz,
                                              const char *fieldName,
                                              jchar value) {
...
template <>
void QAndroidJniObject::setStaticField<jshort>(jclass clazz,
                                               const char *fieldName,
                                               jshort value) {
...
template <>
void QAndroidJniObject::setStaticField<jint>(jclass clazz,
                                             const char *fieldName,
                                             jint value) {
...
template <>
void QAndroidJniObject::setStaticField<jint>(const char *className,
                                             const char *fieldName,
                                             jint value) {
...
template <>
void QAndroidJniObject::setStaticField<jlong>(jclass clazz,
                                              const char *fieldName,
                                              jlong value) {
...
template <>
void QAndroidJniObject::setStaticField<jfloat>(jclass clazz,
                                               const char *fieldName,
                                               jfloat value) {
...
template <>
void QAndroidJniObject::setStaticField<jdouble>(jclass clazz,
                                                const char *fieldName,
                                                jdouble value) {
...
void QAndroidJniObject::setStaticField<jclass>(const char *className,
                                               const char *fieldName,
                                               jclass value) {
  QJNIObjectPrivate::setStaticField<jobject>(className, fieldName,
                                             "Ljava/lang/Class;", value);
}

template <>
void QAndroidJniObject::setStaticField<jclass>(jclass clazz,
                                               const char *fieldName,
                                               jclass value) {
  QJNIObjectPrivate::setStaticField<jobject>(clazz, fieldName,
                                             "Ljava/lang/Class;", value);
}
...
template <>
void QAndroidJniObject::setStaticField<jstring>(jclass clazz,
                                                const char *fieldName,
                                                jstring value) {
  QJNIObjectPrivate::setStaticField<jobject>(clazz, fieldName,
                                             "Ljava/lang/String;", value);
...
QAndroidJniObject QAndroidJniObject::fromString(const std::string &string) {
...
bool QAndroidJniObject::isValid() const { return d->isValid(); }

QAndroidJniObject QAndroidJniObject::fromLocalRef(jobject obj) {
  return QJNIObjectPrivate::fromLocalRef(obj);
}

jobject QAndroidJniObject::javaObject() const { return d->object(); }
...
void QAndroidJniObject::assign(jobject o) {
  if (d->isSameObject(o)) return;

  d = std::shared_ptr<QJNIObjectPrivate>(new QJNIObjectPrivate(o));
}
