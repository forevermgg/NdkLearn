...
#ifndef FFOREVER_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
#define FFOREVER_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
...
#endif  // FFOREVER_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
